...
您将需要一艘船来开始探索虚幻引擎，所以抓住一艘潜艇吧！您下载的材料包括低聚潜艇模型。在 zip 文件中，您会找到模型的3D 模型 (fbx) *submarine-low-poly/submarine.fbx*和纹理*submarine-low-poly/\*.png 。*
